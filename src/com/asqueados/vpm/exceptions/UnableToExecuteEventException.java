/*
 * UnableToExecuteEventException.java
 * 
 ...
 */
public class UnableToExecuteEventException extends Exception{
    private static final String message="Unable to execute event";
    
    public UnableToExecuteEventException(){
        super(message);
    }
    
    public UnableToExecuteEventException(Exception cause) {
        super(message, cause);
    }
