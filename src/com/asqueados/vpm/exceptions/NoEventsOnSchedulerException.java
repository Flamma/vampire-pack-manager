/*
 * NoEventsOnSchedulerException.java
 * 
 ...
 */
public class NoEventsOnSchedulerException extends Exception {
    private static final String message="No elements on scheduler";
    
    public NoEventsOnSchedulerException(){
        super(message);
    }
    
    public NoEventsOnSchedulerException(Exception cause) {
        super(message, cause);
    }
