/*
 * UnableToReadArchetypeException.java
 * 
 ...
 */
public class UnableToCreatePersonageException extends Exception {

    public UnableToCreatePersonageException(Exception cause) {
        super(cause);
    }
