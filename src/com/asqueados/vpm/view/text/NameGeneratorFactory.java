...
public class NameGeneratorFactory {
    ...
    public static NameGenerator createNameGenerator(String type, String file) {
        // Type is ignored by now
        NameGenerator result=null;
        
        result = new XmlNameGenerator(file);
