 ...
 */
public class ColorDescriptorFactory {
    public static ColorDescriptor getColorDescriptor() {
        return getColorDescriptor(null);
    }
    
    public static ColorDescriptor getColorDescriptor(String type) {
        return new DefaultColorDescriptor();
    }
